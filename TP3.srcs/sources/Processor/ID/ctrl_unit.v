...
module ctrl_register
    ...
    (
        input  wire          i_bus_A_diff_bus_B, // is bus A different from bus B?
    ...
    */
    ...
    //             end
    //             OPP_BEQ : begin
    //                 next_pc_src <= !i_bus_A_diff_bus_B ? { CTRL_NEXT_PC_SRC_NOT_SEQ, CTRL_JMP_BRANCH } : { CTRL_NEXT_PC_SRC_SEQ, CTRL_NOT_JMP };
    //                 jmp_ctrl <= i_bus_A_diff_bus_B ? CTRL_JMP_BRANCH : CTRL_NOT_JMP;
    //                 reg_dst <= CTRL_REG_DST_NOTHING;
    //                 alu_src_A <= ALU_CTRL_SRC_A_NOTHING;
    //                 alu_src_B <= ALU_CTRL_SRC_B_NOTHING;
