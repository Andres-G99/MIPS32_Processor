...
module memory_printer
    ...
    localparam MEMORY_PRINTER_STATE_IDLE = 2'b00;
    localparam MEMORY_PRINTER_STATE_PRINT = 2'b01;
    localparam MEMORY_PRINTER_STATE_WAIT_WR_TRANSITION = 2'b10;
    localparam MEMORY_PRINTER_STATE_WAIT_WR = 2'b11;
